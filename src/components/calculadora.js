    ...
    return html`
      ...
      <div class="card bg-dark text-white p-3">
        ...
        <div class="container">
          ...
          <div class="row g-2 mt-1">
            <div class="col-sm-3"><boton-numero value="0" @numero-click=${this.insertar}></boton-numero></div>
            <div class="col-sm-3"><boton-numero value="." @numero-click=${this.insertar}></boton-numero></div>
            <div class="col-sm-3"><button class="btn btn-danger btn-ac w-100" @click=${this.clear}>AC</button></div>
            <div class="col-sm-3"><boton-operacion op="/" @operacion-click=${this.agregarOperacion}></boton-operacion></div></div>
            <div class="row g-2 mt-1"><div class="col-sm-12"><button class="btn btn-success w-100 btn-equals" @click=${this.calcular}>=</button></div>
          </div>
        </div>
      </div>
    `;
